    ...
    <aside id="minileftbar" class="minileftbar">
        <ul class="menu_list">
            <li>
                ...
                <a class="navbar-brand" href="{{ route('blogUserDashboard') }}"><img
            ...
            <li class="power">
                ...
                <a href="{{ route('blogSignOut') }}" class="mega-menu"><i class="zmdi zmdi-power"></i></a>
            </li>
                ...
                <ul class="list">
                    <li>
                        <div class="user-info m-b-20">
                            <div class="image">
                                <a href="{{ route("blogUserProfile", Auth::guard("author")->user()->username) }}">
                                    @if (Auth::guard('author')->user()->image == null)
                                        <img src="{{ Avatar::create(Auth::guard('author')->user()->name)->toBase64() }}" />
                                    @else
                                        <img src="{{ asset('uploads/user/profile/'.Auth::guard('author')->user()->image) }}" alt="User">
                                    @endif
                                </a>
                            </div>
                            <div class="detail">
                                <h6>{{ Auth::guard('author')->user()->name }}</h6>
                                <p class="m-b-0">{{ Auth::guard('author')->user()->email }}</p>
                    ...
                    <li class="@yield('blogDashboardActive')"><a href="{{ route('blogUserDashboard') }}"><i
                                class="zmdi zmdi-blogger"></i><span>Blog Dashboard</span> </a> </li>
                    <li class="@yield('newPostActive')"> <a href="{{ route('userNewPost') }}"><i
                                class="zmdi zmdi-plus-circle"></i><span>New Post</span> </a> </li>
                    <li class="@yield('postListActive')"><a href="{{ route('userPostList') }}"><i
                                class="zmdi zmdi-sort-amount-desc"></i><span>Post List</span> </a>
                    </li>
                </ul>
            </div>
        </div>
